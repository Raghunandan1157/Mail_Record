...
assert.equal(restoredAdminMode(true, undefined), true, 'admin user defaults to admin UI');
assert.equal(restoredAdminMode(true, 'corporate'), false, 'corporate view uses regular branch UI (only admin view shows admin dashboard)');
